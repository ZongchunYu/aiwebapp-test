...
def parse_multiple_images():
    ...
    return render_template('index.html', message=msg, history_pictures=list_history(results), sample_results=['1'])
...
def upload_image():
    if request.method == 'POST':
        ...
        if not uploaded_files:
            ...
            return render_template('index.html', message=msg, history_pictures=list_history())
        ...
        return render_template('index.html', message=msg, items=results, history_pictures=list_history(), sample_results=[])

    return render_template('index.html', message=msg, history_pictures=list_history(), sample_results=[])
